...
#define WIZ_SPIx_RCC_CLK_ENABLE()        __HAL_RCC_SPI2_CLK_ENABLE()   /* 定义W5500所用的SPI接口时钟   */

#define WIZ_SPI_GPIO_ClK_ENABLE()        __HAL_RCC_GPIOB_CLK_ENABLE() /* GPIO端口时钟                 */
#define WIZ_SPIx_GPIO_PORT               GPIOB									  	  /* GPIO端口                     */
#define WIZ_SPIx_SCLK_PIN                GPIO_PIN_13						   	    /* 定义W5500的时钟管脚          */
#define WIZ_SPIx_MISO_PIN                GPIO_PIN_14						   	    /* 定义W5500的MISO管脚          */
#define WIZ_SPIx_MOSI_PIN                GPIO_PIN_15						   	    /* 定义W5500的MOSI管脚          */

#define WIZ_SPIx_SCS_PIN                 GPIO_PIN_9						   	  /* 定义W5500的片选管脚          */
#define WIZ_SPIx_SCS_PORT                GPIOB									   	  /* GPIO端口                     */
#define WIZ_SPIx_SCS_CLK_ENABLE()        __HAL_RCC_GPIOB_CLK_ENABLE()	/* GPIO端口时钟                 */

#define WIZ_INT_PIN                      GPIO_PIN_5									  /* 定义W5500的INT管脚           */
#define WIZ_INT_PORT                     GPIOB									  	  /* GPIO端口                     */
#define WIZ_INT_CLK_ENABLE()             __HAL_RCC_GPIOB_CLK_ENABLE() /* GPIO端口时钟                 */

#define WIZ_RESET_PIN                   GPIO_PIN_4									  /* 定义W5500的RESET管脚           */
